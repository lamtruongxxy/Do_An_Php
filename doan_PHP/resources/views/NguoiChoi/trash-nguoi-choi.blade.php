                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="datatable" class="table dt-responsive nowrap">
                                    ...
                                    <tbody>
                                    	@foreach($trashNguoiChoi as $nguoichoi)
                                        <tr>
                                            <td>{{ $nguoichoi->id }} </td>
                                            ...
                                            <td> 
                                                <a href="{{ route('nguoi-choi.restore', ['id'=>$nguoichoi->id ]) }}" class="btn btn-info waves-effect waves-light" id="luu-thanh-cong" ><i class="fe-chevrons-up"> Khôi phục</i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
